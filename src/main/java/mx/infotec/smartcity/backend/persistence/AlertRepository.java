...
public interface AlertRepository extends MongoRepository<Alert, Integer> {
    ...
    public Page<Alert> findByAlertTypeAndDateTimeBetweenOrderByDateTimeDesc(String alertType, Date start, Date end, Pageable pageable);
    public Page<Alert> findByAlertTypeAndEventObservedAndDateTimeBetweenOrderByDateTimeDesc(String alertType, String subalertType, Date start, Date end, Pageable pageable);
    ...
    public Page<Alert> findByRefUserAndAlertTypeAndEventObservedOrderByDateTimeDesc(String id, String alertType, String subalertType, Pageable pageable);
    
    public Page<Alert> findByRefUserAndDateTimeBetweenOrderByDateTimeDesc(String id, Date start, Date end, Pageable pageable);
    public Page<Alert> findByRefUserAndAlertTypeAndDateTimeBetweenOrderByDateTimeDesc(String id, String alertType, Date start, Date end, Pageable pageable);
    public Page<Alert> findByRefUserAndAlertTypeAndEventObservedAndDateTimeBetweenOrderByDateTimeDesc(String id, String alertType, String subalertType, Date start, Date end, Pageable pageable);
}